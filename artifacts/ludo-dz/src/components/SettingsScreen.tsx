...
import { BoardThemeThumbnail } from './BoardThemeThumbnail';
import {
  isSoundEnabled,
  setSoundEnabled,
  isBgmEnabled,
                  ...
                  <div className="px-4 pb-4">
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0 rounded-lg overflow-hidden"
                        ...
                        <BoardThemeThumbnail boardStyle="neon" size={42}/>
                      </div>
                      <span
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0 rounded-lg overflow-hidden"
                        ...
                        <BoardThemeThumbnail boardStyle="classic" size={42}/>
                      </div>
                      <span
                        className="font-heading font-bold relative z-10 flex-1 px-3"
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0 rounded-lg overflow-hidden"
                        style={boardStyle === 'dz'
                          ...
                          : { border: "1px solid rgba(255,255,255,0.14)" }}>
                        <BoardThemeThumbnail boardStyle="dz" size={42}/>
                      </div>
                      <span
                        className="font-heading font-bold relative z-10 flex-1 px-3"
                    ...
                    >
                      ...
                      <div className="relative z-10 flex-shrink-0 rounded-lg overflow-hidden"
                        style={boardStyle === 'normal'
                          ...
                          : { border: "1px solid rgba(255,255,255,0.14)" }}>
                        <BoardThemeThumbnail boardStyle="normal" size={42}/>
                      </div>
                      <span
                        className="font-heading font-bold relative z-10 flex-1 px-3"
